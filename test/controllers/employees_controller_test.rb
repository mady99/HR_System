...
class EmployeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employee" do
    assert_difference("Employee.count") do
      post employees_url, params: { employee: { email: @employee.email, employment_status: @employee.employment_status, job: @employee.job, name: @employee.name, salary: @employee.salary } }
    end
