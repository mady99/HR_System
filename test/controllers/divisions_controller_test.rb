...
class DivisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create division" do
    assert_difference("Division.count") do
      post divisions_url, params: { division: { description: @division.description, manager: @division.manager, name: @division.name, teams: @division.teams } }
    end
  ...
  test "should update division" do
    patch division_url(@division), params: { division: { description: @division.description, manager: @division.manager, name: @division.name, teams: @division.teams } }
